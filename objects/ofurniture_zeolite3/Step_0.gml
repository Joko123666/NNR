...
if place_meeting(x,y,oPlayer) && oPlayer.input.interaction	&& act_count <=0
{
	...
	text.text_line01 = terminal_text_02(1);
	text.text_line02 = terminal_text_02(2);
	text.text_line03 = terminal_text_02(3);
	text.text_line04 = terminal_text_02(4);
	text.text_line05 = terminal_text_02(5);
	text.text_line06 = terminal_text_02(6);
