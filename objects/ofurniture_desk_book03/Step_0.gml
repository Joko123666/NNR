...
if place_meeting(x,y,oPlayer) && oPlayer.input.interaction	&& act_count <=0
{
	...
	text.text_line01 = book_text_03(1);
	text.text_line02 = book_text_03(2);
	text.text_line03 = book_text_03(3);
	text.text_line04 = book_text_03(4);
	text.text_line05 = book_text_03(5);
	text.text_line06 = book_text_03(6);
