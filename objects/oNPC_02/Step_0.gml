...
dialog_count = global.NPC2_dialog;
...
if place_meeting(x,y,oPlayer) && oPlayer.input.interaction	&& act_count <=0	&& dialog_endswitch == false
{
	...
	text.text = NPC_NPC02_dialog(dialog_count);
	text.dianame = "바레타"
	text.name_color = c_orange;
...
if deactivate_count > 0
	{state_set_sprite(NPC_village_02_active, 1, 0); deactivate_count--;}
else {state_set_sprite(NPC_village_02, 1, 0);}