...
dialog_count = global.NPC8_dialog;
...
if place_meeting(x,y,oPlayer) && oPlayer.input.interaction	&& act_count <=0	&& dialog_endswitch == false
{
	...
	text.text = NPC_NPC8_dialog(dialog_count);
	text.dianame = "해롤드"
	text.name_color = c_maroon;
...
if deactivate_count > 0
	{state_set_sprite(NPC_village_08_active, 1, 0); deactivate_count--;}
else {state_set_sprite(NPC_village_08, 1, 0);}