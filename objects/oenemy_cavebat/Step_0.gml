...
switch (state)
{
	...
	#region Attack state
		...
		move_and_collide_enemy(move_speed * image_xscale, moving_speed);
		...
		{creat_hitbox(x, y, self, enemy_vally_cavebat_mask, 2, 1, 10, image_xscale); state = "Knockback";}
		
		if place_meeting(x + image_xscale*4, y+2, oWall)
	...
	case "Knockback" :
		#region Knockback_state
			...
			knockback_state(knockback_sprite, "Attack");
