...
{
	var attack1 = instance_create_layer(x, y , "Instances", ofinalboss_attack_fire13);
	var attack2 = instance_create_layer(x, y , "Instances", ofinalboss_attack_fire13);
	var attack3 = instance_create_layer(x, y , "Instances", ofinalboss_attack_fire13);
	var attack4 = instance_create_layer(x, y , "Instances", ofinalboss_attack_fire13);
