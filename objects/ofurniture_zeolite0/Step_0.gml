...
if place_meeting(x,y,oPlayer) && oPlayer.input.interaction	&& act_count <=0
{
	...
	text.text_line01 = terminal_text_00(1);
	text.text_line02 = terminal_text_00(2);
	text.text_line03 = terminal_text_00(3);
	text.text_line04 = terminal_text_00(4);
	text.text_line05 = terminal_text_00(5);
	text.text_line06 = terminal_text_00(6);
