...
dialog_count = global.NPC7_dialog;
...
if place_meeting(x,y,oPlayer) && oPlayer.input.interaction	&& act_count <=0
{
	...
	text.text = NPC_NPC7_dialog(dialog_count);
...
if deactivate_count > 0
	{ deactivate_count--;	state_set_sprite(NPC_village_07_active, 1, 0);}
else
	{state_set_sprite(NPC_village_07, 1, 0);}
