...
if global.UItext_show == false
{
	...
	if oPlayer.state != "Stay"
	{
		...
		{draw_sprite(UI_skillcool_sp1, 0, 4, 152); }
		...
		{draw_sprite_ext(UI_skillcool_gray, 0, 5, 153, (oPlayer.moveskill_cool/oPlayer.moveskill_maxcool), 1, 0, -1, 0.8);}
		
		//스킬 사용키 표시
		var x_arraypoint = 5;
		var y_arraypoint = 140;
	...
	if oPlayer.state != "Stay"
	{
		...
		{draw_sprite(UI_skillact_blue, 0, 31, 151);}
	
		if oPlayer.skillS_cool > 0 
		{draw_sprite_ext(UI_skillcool_gray, 0, 33, 153, (oPlayer.skillS_cool/oPlayer.skillS_maxcool), 1, 0, -1, 0.8);}
	
		if oPlayer.MP < oPlayer.attackskill_cost
		{draw_rectangle_color(32, 152, 56, 176, c_dkgray, c_dkgray, c_dkgray, c_dkgray, false);}
