...
dialog_count = global.NPC15_dialog;
...
if place_meeting(x,y,oPlayer) && oPlayer.input.interaction	&& act_count <=0	&& dialog_endswitch == false
{
	...
	text.text = NPC_NPC15_dialog(dialog_count);
	text.dianame = "길드 접수원"
...
if deactivate_count > 0
	{state_set_sprite(NPC_village_15_active, 1, 0); deactivate_count--;}
else {state_set_sprite(NPC_village_15, 1, 0);}